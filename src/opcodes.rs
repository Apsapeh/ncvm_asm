...
static COMMANDS: [CommandMapNode; 124] = [
    ...
    CommandMapNode::new("irsi", Opcode::IRSI),
    CommandMapNode::new("ilsi", Opcode::ILSI),
    CommandMapNode::new("lrsi", Opcode::LRSI),
    CommandMapNode::new("llsi", Opcode::LLSI),
    CommandMapNode::new("irsa", Opcode::IRSA),
    CommandMapNode::new("ilsa", Opcode::ILSA),
    CommandMapNode::new("lrsa", Opcode::LRSA),
    CommandMapNode::new("llsa", Opcode::LLSA),
    ...
    CommandMapNode::new("ineg", Opcode::INEG),
    ...
    CommandMapNode::new("lneg", Opcode::LNEG),
    ...
    CommandMapNode::new("fneg", Opcode::FNEG),
    ...
    CommandMapNode::new("dneg", Opcode::DNEG),
